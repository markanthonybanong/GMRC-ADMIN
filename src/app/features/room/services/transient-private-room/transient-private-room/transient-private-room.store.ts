  ...
  onSearch(): void {
    const dialogRef = this.dialog.open(
      SearchTransientPrivateRoomComponent, {
        data: {
          title: ROOM_CONFIG.action.searchTransientPrivateRoom
        }
    });
        ...
        this.setState({
          ...
          table: {
            ...
            pageRequest: {
              ...
              limit: 200,
              filters: {
                type: ROOM_CONFIG.filter.type.ADVANCESEARCHTRANSIENTPRIVATEROOMS,
    ...
    this.setState({
      ...
      table: {
        ...
        pageRequest: {
          ...
          limit: 10,
          filters: {
            type: ROOM_CONFIG.filter.type.TRANSIENTPRIVATEROOMS,
          }
        }
      }
    });
